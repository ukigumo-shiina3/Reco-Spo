  ...
  return (
    <UserLayout>
      <div className='w-screen block '>
        <Image
          src='/main-visual/main-visual2.png'
          quality={100}
          width={2000}
          height={700}
          objectFit='contain'
      ...
      <div className='container justify-center mx-auto mt-5 p-5 md:px-10 py-5 max-w-[1080px]'>
        {/* Reco Spoとは */}
        <Image src='/heading/about-heading1.png' width={150} height={50} alt='Reco Spoとは' />
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5 max-w-[1080px]'>
        <Image src='/heading/about-heading2.png' width={150} height={50} alt='制作背景' />
        <p className='mb-4 text-sm'>
      ...
      {/* 使い方 */}
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5 max-w-[1080px]'>
        <Image src='/heading/about-heading3.png' width={150} height={50} alt='使い方' />
