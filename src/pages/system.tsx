  ...
  return (
    <div>
      ...
      <div className='mt-5 p-5 md:px-10 py-5'>
        <Image src='/system-heading1.png' width={180} height={50} alt='居住支援制度とは' />
      ...
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading2.png' width={180} height={50} alt='住宅建築補助とは' />
      ...
      {/* 定住促進奨励金とは */}
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading3.png' width={180} height={50} alt='定住促進奨励金とは' />
      ...
      {/* お試し暮らしとは */}
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading4.png' width={180} height={50} alt='定住促進奨励金とは' />
        <p className='mb-4 text-sm'>
      ...
      {/* 子育て支援とは */}
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading5.png' width={180} height={50} alt='子育て支援とは' />
        <p className='mb-4 text-sm'>
      ...
      {/* 空き家バンクとは */}
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading5.png' width={180} height={50} alt='空き家バンクとは' />
        <p className='mb-4 text-sm'>
      ...
      {/* 仕事への補助金とは */}
      <div className='p-5 md:px-10 py-5'>
        <Image src='/system-heading5.png' width={180} height={50} alt='仕事への補助金とは' />
