  ...
  return (
    <div>
      ...
      <div className='mt-5 mx-10 mb-10 py-8 px-10 sm:mx-20 sm:px-20 rounded-lg bg-gray-200'>
        ...
        <p>
          この利用規約（以下，「本規約」といいます。）は，当サイト管理人（以下，「管理人」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h2 className='text-2xl font-bold my-4'>第1条（適用）</h2>
        <ol>
          <li>
        ...
        <h2 className='text-2xl font-bold my-4'>第2条（利用登録）</h2>
        <ol>
          <li>
        ...
        <h2 className='text-2xl font-bold my-4'>第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol>
          <li>
        ...
        <h2 className='text-2xl font-bold my-4'>第4条（利用料金および支払方法）</h2>
        <ol>
          <li>
        ...
        <h2 className='text-2xl font-bold my-4'>第5条（禁止事項）</h2>
        ...
        <h2 className='text-2xl font-bold my-4'>第6条（本サービスの提供の停止等）</h2>
        <ol>
          <li>
            ・
        ...
        <h2 className='text-2xl font-bold my-4'>第7条（著作権）</h2>
        <ol>
          <li>
            ・
        ...
        <h2 className='text-2xl font-bold my-4'>第8条（利用制限および登録抹消）</h2>
        <ol>
          <li>
            ・
        ...
        <h2 className='text-2xl font-bold my-4'>第9条（退会）</h2>
        <p>ユーザーは，管理人の定める退会手続により，本サービスから退会できるものとします。</p>
        <h2 className='text-2xl font-bold my-4'>第10条（保証の否認および免責事項）</h2>
        <ol>
          <li>
            ・
        ...
        <h2 className='text-2xl font-bold my-4'>第15条（権利義務の譲渡の禁止）</h2>
        <p>
          ユーザーは，管理人の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
        </p>
        <h2 className='text-2xl font-bold my-4'>第16条（準拠法・裁判管轄）</h2>
        <ol>
