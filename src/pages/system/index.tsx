  ...
  return (
    <UserLayout>
      <div className='w-screen block'>
        <Image
          src='/main-visuals/main-visual3.png'
          quality={100}
          width={2000}
          height={650}
          layout='responsive'
      ...
      <div className='container justify-center mx-auto mt-5 p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading1.png'
          quality={100}
          width={180}
          height={50}
          alt='居住支援制度とは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading2.png'
          quality={100}
          width={180}
          height={50}
          alt='住宅建築補助とは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading3.png'
          quality={100}
          width={180}
          height={50}
          alt='定住促進奨励金とは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading4.png'
          quality={100}
          width={180}
          height={50}
          alt='定住促進奨励金とは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading5.png'
          quality={100}
          width={180}
          height={50}
          alt='子育て支援とは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading6.png'
          quality={100}
          width={180}
          height={50}
          alt='空き家バンクとは'
      ...
      <div className='container justify-center mx-auto  p-5 md:px-10 py-5  max-w-[1080px]'>
        <Image
          src='/headings/system-heading7.png'
          quality={100}
          width={180}
          height={50}
          alt='仕事への補助金とは'
