      ...
      <div>
        <div className='text-center  justify-center md:flex'>
          ...
          <div className='w-full max-w-[600px] min-w-[380px] h-[384px]  m-auto md:m-0 '>
            <BackgroundImage src='/about-pic1-new.png' className='h-[384px] object-contain'>
              <div className='pt-12 '>
                {/* p='xl'は上下との行間 */}
          ...
          {/* 住宅建築補助とは */}
          <div className='w-full max-w-[600px] min-w-[380px] h-[384px]  m-auto md:m-0 '>
            <BackgroundImage src='/about-pic2-new.png' className='h-[384px] object-contain'>
              <div className='pt-12'>
                <div>
                  {/* p='xl'は上下との行間 */}
                  <Center p='xl' className=' md:p=xs md:text-xs'>
        ...
        <div className='text-center  justify-center md:flex'>
          {/* 定住促進奨励金とは */}
          <div className='w-full max-w-[600px] min-w-[380px] h-[384px]  m-auto md:m-0 '>
            <BackgroundImage src='/about-pic3-new.png' className='h-[384px] object-contain'>
              <div className='pt-12 '>
                {/* p='xl'は上下との行間 */}
                <Center p='xl' className=' md:p=xs md:text-xs'>
          ...
          {/* お試し移住体験とは  */}
          <div className='w-full max-w-[600px] min-w-[380px] h-[384px]  m-auto md:m-0 '>
            <BackgroundImage src='/about-pic4-new.png' className='h-[384px] object-contain'>
              <div className='pt-12 '>
                {/* p='xl'は上下との行間 */}
                <Center p='xl' className=' md:p=xs md:text-xs'>
